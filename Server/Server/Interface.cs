...
namespace Server
{
    ...
    _____     _                            _     
   /__   \___| | ___  __ _ _ __ __ _ _ __ | |__  
     / /\/ _ \ |/ _ \/ _` | '__/ _` | '_ \| '_ \ 
    / / |  __/ |  __/ (_| | | | (_| | |_) | | | |
    \/   \___|_|\___|\__, |_|  \__,_| .__/|_| |_|
        ...
        private static void ErrorMessageShow<T>(IEnumerable<T> Answers, int AnswerIndex, string message)
        {
            ...
            Console.SetCursorPosition(CursorLeft + 1, 15 + AnswerIndex * 2);
        ...
        {
            int CursorLeft = Answers.ToArray()[AnswerIndex].ToString().Length + 7;
            Console.SetCursorPosition(CursorLeft, 15 + AnswerIndex * 2);//15 is a row, where the first button is located
